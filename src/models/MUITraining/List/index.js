...
import { Stack, Tooltip, IconButton, CircularProgress, Box, Grid } from '@mui/material';
...
export default function List({
  ...
  return (
    <>
      ...
      <NewDialogContent>
        <Box sx={{ flexGrow: 1 }}>
          <Grid container spacing={2} minHeight={isPopup ? 'calc(100vh - 245px)' : 'calc(100vh - 264px)'}>
            {result.map((model, i) => (
              <Model
                key={i}
                model={model}
