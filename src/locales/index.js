...
const locales = {
  en: {
    ...
    natural_employer: 'Natural Employer',
    ...
    natural_owner: 'Natural Owner',
    legal_owner: 'Leagal Owner',
    task: 'Task',
    tasks: 'Tasks',
  ...
  fa: {
    ...
    match_location: 'تطبیق موقعیت مکانی',
    gender: 'جنسیت',
    ...
    woman: 'خانم',
    price: 'قیمت',
    financials: 'ردیف‌های مالی',
    financialSituation: 'وضعیت مالی',
    report_number: 'شماره گزارش',
    ...
    supervisor: 'ناظر',
    employer: 'کارفرما',
    legal_employer: 'شرکت (حقوقی)',
    natural_employer: 'سرپرست (حقیقی)',
    ...
    owner: 'مالک',
    owner_type: 'نوع مالک',
    natural_owner: 'مالک (کارفرما)',
    legal_owner: 'مالک (شرکت)',
    task: 'فعالیت',
    tasks: 'فعالیت‌ها',
